                    ...
                    <div class="wow bounceInDown" data-wow-delay="0.4s">
                        <div class="section-heading">
                            ...
                            <script>
                                switch(${soc}) {
                                    case 0: {
                                        $('#dropdownMenuButton').text('VK');
                                        break;
                                    }
                                    case 1: {
                                        $('#dropdownMenuButton').text('Одноклассники');
                                        break;
                                    }
                                    case 2: {
                                        $('#dropdownMenuButton').text('Facebook');
                                        break;
                                    }
                                    case 3: {
                                        $('#dropdownMenuButton').text('Instagram');
                                        break;
                                    }
                                }
                            </script>
    ...
    <#if (publics?size > 0)>
        ...
        <div class="col-md-9 col-md-offset-2"
             style="font-size: 2.2em;
                    ...
                    color: #b4b4b4;">
            <div class="wow bounceInUp" data-wow-delay="0.5s">
                <span>По этому запросу ничего не найдено.</span>
            </div>
        </div>
        </#if>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $("form").submit(function(e) {
            ...
            if ($('#members_from').val() != "") {
                if ( $('#members_to').val() != "" && $('#members_from').val() > $('#members_to').val()) {
                    $('#members_to').css('border','1px solid red');
                    haveError = true;
                }
            }
            if ($('#cost_from').val() != "") {
                if ( $('#cost_to').val() != "" && $('#cost_from').val() > $('#cost_to').val()) {
                    console.log($('#cost_from').val());
                    console.log($('#cost_to').val());
